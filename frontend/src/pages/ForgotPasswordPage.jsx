    ...
    return (
      <div className="auth-page">
        <div className="card">
          ...
          <p className="muted">
            The link opens a page where you choose a new password. If nothing arrives, the address
            may not have an account, or the account may still be waiting for the Barangay
    ...
    <div className="auth-page">
      <form className="card" onSubmit={handleSubmit}>
        ...
        <p className="subtitle">
          Enter the email address on your BrgyServe account and we will send you a link to set a
          new password.
        </p>
