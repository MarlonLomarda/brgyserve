...
- **Build order:** (1) rental items setup → (2) resident submission + tracking with the conflict check (instant confirmation) → (3) Secretary schedule management (view/edit/cancel) → (4) payment.
